...
_trace_test:     file format elf32-i386
...
main(void)
{
  ...
  trace(1);
  11:	6a 01                	push   $0x1
  13:	e8 1b 03 00 00       	call   333 <trace>

  pid = getpid();
  18:	e8 f6 02 00 00       	call   313 <getpid>
  printf(1, "My PID is %d\n", pid);
  1d:	83 c4 0c             	add    $0xc,%esp
  20:	50                   	push   %eax
  21:	68 e8 06 00 00       	push   $0x6e8
  26:	6a 01                	push   $0x1
  28:	e8 b3 03 00 00       	call   3e0 <printf>

  trace(0);
  2d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  34:	e8 fa 02 00 00       	call   333 <trace>

  printf(1, "Tracing is now disabled\n");
  39:	58                   	pop    %eax
  3a:	5a                   	pop    %edx
  3b:	68 f6 06 00 00       	push   $0x6f6
  40:	6a 01                	push   $0x1
  42:	e8 99 03 00 00       	call   3e0 <printf>

  exit();
  47:	e8 47 02 00 00       	call   293 <exit>
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 560:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 565:	bb 0f 07 00 00       	mov    $0x70f,%ebx
...
free(void *ap)
{
 ...
 571:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 5af:	5b                   	pop    %ebx
  freep = p;
 5b0:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 5b5:	5e                   	pop    %esi
 5b6:	5f                   	pop    %edi
 5b7:	5d                   	pop    %ebp
 ...
 5c6:	72 ce                	jb     596 <free+0x26>
{
 ...
 5e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5ea:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64b:	3b 05 0c 0a 00 00    	cmp    0xa0c,%eax
 ...
 66e:	e8 fd fe ff ff       	call   570 <free>
  return freep;
 673:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 69f:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 ...
 6af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6b0:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 6b7:	0a 00 00 
    base.s.size = 0;
 6ba:	b8 10 0a 00 00       	mov    $0xa10,%eax
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 6c6:	0a 00 00 
    base.s.size = 0;
 6c9:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 6d0:	00 00 00 
    if(p->s.size >= nunits){
