...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
...
8010064b:	0f b6 92 44 77 10 80 	movzbl -0x7fef88bc(%edx),%edx
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 71 63 00 00       	call   80106e90 <setupkvm>
...
80100b8b:	e8 30 61 00 00       	call   80106cc0 <allocuvm>
...
80100bc1:	e8 2a 60 00 00       	call   80106bf0 <loaduvm>
...
80100c03:	e8 08 62 00 00       	call   80106e10 <freevm>
  if(ip){
...
80100cee:	e8 0d 64 00 00       	call   80107100 <copyout>
...
80100d03:	e8 08 61 00 00       	call   80106e10 <freevm>
...
80100d5f:	e8 9c 63 00 00       	call   80107100 <copyout>
...
80100dcb:	e8 90 5c 00 00       	call   80106a60 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 38 60 00 00       	call   80106e10 <freevm>
  return 0;
...
80101613:	68 58 77 10 80       	push   $0x80107758
...
80102068:	68 fb 75 10 80       	push   $0x801075fb
...
8010240a:	68 ac 77 10 80       	push   $0x801077ac
...
8010271b:	0f b6 91 20 7a 10 80 	movzbl -0x7fef85e0(%ecx),%edx
  shift ^= togglecode[data];
80102722:	0f b6 81 20 79 10 80 	movzbl -0x7fef86e0(%ecx),%eax
  shift |= shiftcode[data];
...
80102738:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010273b:	8b 04 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%eax
...
80102775:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102778:	0f b6 81 20 7a 10 80 	movzbl -0x7fef85e0(%ecx),%eax
...
80102ff2:	e8 59 29 00 00       	call   80105950 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 35 3a 00 00       	call   80106a50 <switchkvm>
  seginit();
8010301b:	e8 a0 39 00 00       	call   801069c0 <seginit>
  lapicinit();
...
80103074:	e8 b7 2b 00 00       	call   80105c30 <uartinit>
  pinit();         // process table
80103079:	e8 52 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 4d 28 00 00       	call   801058d0 <tvinit>
  binit();         // buffer cache
...
801033d8:	68 e0 77 10 80       	push   $0x801077e0
...
801037de:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tracing = 0;
801037e5:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->pid = nextpid++;
...
8010381f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103822:	c7 40 14 bf 58 10 80 	movl   $0x801058bf,0x14(%eax)
  p->context = (struct context*)sp;
...
801038d6:	68 36 74 10 80       	push   $0x80107436
...
801039b3:	e8 d8 34 00 00       	call   80106e90 <setupkvm>
...
80103a3f:	68 66 74 10 80       	push   $0x80107466
80103a44:	50                   	push   %eax
80103a45:	e8 16 0e 00 00       	call   80104860 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 6f 74 10 80 	movl   $0x8010746f,(%esp)
...
80103a83:	68 4d 74 10 80       	push   $0x8010744d
...
80103ada:	e8 e1 31 00 00       	call   80106cc0 <allocuvm>
...
80103b48:	e8 33 34 00 00       	call   80106f80 <copyuvm>
...
80103c70:	e8 eb 2d 00 00       	call   80106a60 <switchuvm>
...
80103c82:	e8 34 0c 00 00       	call   801048bb <swtch>
      switchkvm();
80103c87:	e8 c4 2d 00 00       	call   80106a50 <switchkvm>
      c->proc = 0;
...
80103e8d:	68 be 74 10 80       	push   $0x801074be
80103e92:	e8 e9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103e97:	83 ec 0c             	sub    $0xc,%esp
80103e9a:	68 b1 74 10 80       	push   $0x801074b1
...
80103f79:	e8 92 2e 00 00       	call   80106e10 <freevm>
        p->pid = 0;
...
80103fd0:	68 ca 74 10 80       	push   $0x801074ca
...
801040d9:	68 d0 74 10 80       	push   $0x801074d0
801040de:	e8 9d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040e3:	83 ec 0c             	sub    $0xc,%esp
801040e6:	68 ca 74 10 80       	push   $0x801074ca
...
8010420c:	74 ea                	je     801041f8 <procdump+0x28>
      state = "???";
8010420e:	ba e1 74 10 80       	mov    $0x801074e1,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104213:	83 f8 05             	cmp    $0x5,%eax
80104216:	77 11                	ja     80104229 <procdump+0x59>
80104218:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
      state = "???";
8010421f:	b8 e1 74 10 80       	mov    $0x801074e1,%eax
...
8010422e:	68 e5 74 10 80       	push   $0x801074e5
...
8010429a:	68 18 75 10 80       	push   $0x80107518
...
801044f5:	68 23 75 10 80       	push   $0x80107523
801044fa:	e8 81 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 3a 75 10 80       	push   $0x8010753a
...
8010456b:	68 41 75 10 80       	push   $0x80107541
...
80104698:	68 49 75 10 80       	push   $0x80107549
...
80104ab5:	83 f8 15             	cmp    $0x15,%eax
80104ab8:	77 46                	ja     80104b00 <syscall+0x60>
80104aba:	8b 04 b5 a0 7b 10 80 	mov    -0x7fef8460(,%esi,4),%eax
80104ac1:	85 c0                	test   %eax,%eax
80104ac3:	74 3b                	je     80104b00 <syscall+0x60>
	 curproc->tf->eax = syscalls[num]();
80104ac5:	ff d0                	call   *%eax
80104ac7:	8b 53 18             	mov    0x18(%ebx),%edx
80104aca:	89 42 1c             	mov    %eax,0x1c(%edx)
	 
	 if(curproc->tracing){
80104acd:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104ad0:	85 c0                	test   %eax,%eax
80104ad2:	74 4b                	je     80104b1f <syscall+0x7f>
		 cprintf("\n%d: syscall %s -> %d\n", 
80104ad4:	8b 43 18             	mov    0x18(%ebx),%eax
80104ad7:	ff 70 1c             	push   0x1c(%eax)
80104ada:	ff 34 b5 40 7b 10 80 	push   -0x7fef84c0(,%esi,4)
80104ae1:	ff 73 10             	push   0x10(%ebx)
80104ae4:	68 51 75 10 80       	push   $0x80107551
80104ae9:	e8 c2 bb ff ff       	call   801006b0 <cprintf>
...
80104af1:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104af4:	5b                   	pop    %ebx
80104af5:	5e                   	pop    %esi
80104af6:	5d                   	pop    %ebp
80104af7:	c3                   	ret
...
80104b08:	68 68 75 10 80       	push   $0x80107568
...
80104b4a:	e8 51 d5 ff ff       	call   801020a0 <nameiparent>
...
80104b5c:	e8 3f cc ff ff       	call   801017a0 <ilock>
...
80104b68:	e8 83 d1 ff ff       	call   80101cf0 <dirlookup>
...
80104b7a:	e8 b1 ce ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
80104b7f:	89 34 24             	mov    %esi,(%esp)
80104b82:	e8 19 cc ff ff       	call   801017a0 <ilock>
...
80104bac:	e8 7f ce ff ff       	call   80101a30 <iunlockput>
    return 0;
...
80104bca:	e8 61 ca ff ff       	call   80101630 <ialloc>
...
80104be0:	e8 bb cb ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80104c01:	e8 ea ca ff ff       	call   801016f0 <iupdate>
...
80104c18:	e8 a3 d3 ff ff       	call   80101fc0 <dirlink>
...
80104c28:	e8 03 ce ff ff       	call   80101a30 <iunlockput>
  return ip;
...
80104c49:	e8 a2 ca ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c4e:	83 c4 0c             	add    $0xc,%esp
80104c51:	ff 76 04             	push   0x4(%esi)
80104c54:	68 f1 75 10 80       	push   $0x801075f1
80104c59:	56                   	push   %esi
80104c5a:	e8 61 d3 ff ff       	call   80101fc0 <dirlink>
...
80104c6c:	68 f0 75 10 80       	push   $0x801075f0
80104c71:	56                   	push   %esi
80104c72:	e8 49 d3 ff ff       	call   80101fc0 <dirlink>
...
80104d18:	e8 a3 c1 ff ff       	call   80100ec0 <filedup>
  return fd;
...
80104d94:	e8 a7 c2 ff ff       	call   80101040 <fileread>
...
80104e14:	e8 b7 c2 ff ff       	call   801010d0 <filewrite>
...
80104e74:	e8 97 c0 ff ff       	call   80100f10 <fileclose>
  return 0;
...
80104edb:	e8 10 c1 ff ff       	call   80100ff0 <filestat>
...
80104f32:	0f 88 e2 00 00 00    	js     8010501a <sys_link+0x11a>
  begin_op();
80104f38:	e8 03 de ff ff       	call   80102d40 <begin_op>
  if((ip = namei(old)) == 0){
80104f3d:	83 ec 0c             	sub    $0xc,%esp
80104f40:	ff 75 d4             	push   -0x2c(%ebp)
80104f43:	e8 38 d1 ff ff       	call   80102080 <namei>
...
80104f59:	e8 42 c8 ff ff       	call   801017a0 <ilock>
  if(ip->type == T_DIR){
...
80104f78:	e8 73 c7 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
80104f7d:	89 1c 24             	mov    %ebx,(%esp)
80104f80:	e8 fb c8 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f85:	58                   	pop    %eax
80104f86:	5a                   	pop    %edx
80104f87:	57                   	push   %edi
80104f88:	ff 75 d0             	push   -0x30(%ebp)
80104f8b:	e8 10 d1 ff ff       	call   801020a0 <nameiparent>
...
80104f9d:	e8 fe c7 ff ff       	call   801017a0 <ilock>
...
80104fb3:	e8 08 d0 ff ff       	call   80101fc0 <dirlink>
...
80104fc3:	e8 68 ca ff ff       	call   80101a30 <iunlockput>
  iput(ip);
80104fc8:	89 1c 24             	mov    %ebx,(%esp)
80104fcb:	e8 00 c9 ff ff       	call   801018d0 <iput>
  end_op();
80104fd0:	e8 db dd ff ff       	call   80102db0 <end_op>
  return 0;
...
80104fec:	e8 3f ca ff ff       	call   80101a30 <iunlockput>
    goto bad;
80104ff1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104ff4:	83 ec 0c             	sub    $0xc,%esp
80104ff7:	53                   	push   %ebx
80104ff8:	e8 a3 c7 ff ff       	call   801017a0 <ilock>
  ip->nlink--;
80104ffd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105002:	89 1c 24             	mov    %ebx,(%esp)
80105005:	e8 e6 c6 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
8010500a:	89 1c 24             	mov    %ebx,(%esp)
8010500d:	e8 1e ca ff ff       	call   80101a30 <iunlockput>
  end_op();
80105012:	e8 99 dd ff ff       	call   80102db0 <end_op>
  return -1;
...
80105025:	e8 06 ca ff ff       	call   80101a30 <iunlockput>
    end_op();
...
80105032:	eb e6                	jmp    8010501a <sys_link+0x11a>
    end_op();
80105034:	e8 77 dd ff ff       	call   80102db0 <end_op>
    return -1;
...
80105088:	e8 13 c7 ff ff       	call   801017a0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 f1 75 10 80       	push   $0x801075f1
80105094:	53                   	push   %ebx
80105095:	e8 36 cc ff ff       	call   80101cd0 <namecmp>
...
801050a8:	68 f0 75 10 80       	push   $0x801075f0
801050ad:	53                   	push   %ebx
801050ae:	e8 1d cc ff ff       	call   80101cd0 <namecmp>
...
801050c7:	e8 24 cc ff ff       	call   80101cf0 <dirlookup>
...
801050dd:	e8 be c6 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
...
80105132:	e8 f9 c8 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105137:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010513c:	89 1c 24             	mov    %ebx,(%esp)
8010513f:	e8 ac c5 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105144:	89 1c 24             	mov    %ebx,(%esp)
80105147:	e8 e4 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010514c:	e8 5f dc ff ff       	call   80102db0 <end_op>
  return 0;
...
8010517d:	e8 2e c9 ff ff       	call   80101ab0 <readi>
...
80105195:	e8 96 c8 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
801051a6:	e8 85 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
801051ab:	e8 00 dc ff ff       	call   80102db0 <end_op>
  return -1;
...
8010521f:	e8 fc f7 ff ff       	call   80104a20 <argstr>
...
80105238:	e8 23 f7 ff ff       	call   80104960 <argint>
...
80105242:	78 79                	js     801052bd <sys_open+0xad>
  ...
  begin_op();
80105244:	e8 f7 da ff ff       	call   80102d40 <begin_op>
...
80105255:	e8 26 ce ff ff       	call   80102080 <namei>
...
8010526b:	e8 30 c5 ff ff       	call   801017a0 <ilock>
...
8010527e:	e8 cd bb ff ff       	call   80100e50 <filealloc>
...
801052a4:	e8 67 bc ff ff       	call   80100f10 <fileclose>
801052a9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801052ac:	83 ec 0c             	sub    $0xc,%esp
801052af:	56                   	push   %esi
801052b0:	e8 7b c7 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
801052f8:	e8 83 c5 ff ff       	call   80101880 <iunlock>
  end_op();
801052fd:	e8 ae da ff ff       	call   80102db0 <end_op>
...
80105353:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105356:	e8 e5 d9 ff ff       	call   80102d40 <begin_op>
...
8010538f:	e8 9c c6 ff ff       	call   80101a30 <iunlockput>
  end_op();
...
801053b3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801053b6:	e8 85 d9 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010541e:	e8 0d c6 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105423:	e8 88 d9 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010544d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010544f:	e8 ec d8 ff ff       	call   80102d40 <begin_op>
...
8010546f:	e8 0c cc ff ff       	call   80102080 <namei>
...
80105481:	e8 1a c3 ff ff       	call   801017a0 <ilock>
  if(ip->type != T_DIR){
...
80105494:	e8 e7 c3 ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
80105499:	58                   	pop    %eax
8010549a:	ff 76 68             	push   0x68(%esi)
8010549d:	e8 2e c4 ff ff       	call   801018d0 <iput>
  end_op();
801054a2:	e8 09 d9 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
...
801054c4:	e8 67 c5 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
80105521:	e8 3a f4 ff ff       	call   80104960 <argint>
...
80105540:	e8 6b f1 ff ff       	call   801046b0 <memset>
...
8010556a:	e8 61 f3 ff ff       	call   801048d0 <fetchint>
...
80105588:	e8 83 f3 ff ff       	call   80104910 <fetchstr>
...
801055f1:	e8 ba f3 ff ff       	call   801049b0 <argptr>
...
80105647:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010564a:	e8 21 e3 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
801056c0:	e9 4b e4 ff ff       	jmp    80103b10 <fork>
...
801056d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056d6:	e8 a5 e6 ff ff       	call   80103d80 <exit>
...
{
  return wait();
801056e0:	e9 cb e7 ff ff       	jmp    80103eb0 <wait>
...
8010570e:	e8 3d ea ff ff       	call   80104150 <kill>
...
80105733:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105736:	e8 35 e2 ff ff       	call   80103970 <myproc>
...
80105766:	e8 25 e3 ff ff       	call   80103a90 <growproc>
...
801057ac:	68 80 3d 11 80       	push   $0x80113d80
801057b1:	e8 fa ed ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057b6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057b9:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
801057d3:	68 80 3d 11 80       	push   $0x80113d80
801057d8:	68 60 3d 11 80       	push   $0x80113d60
801057dd:	e8 4e e8 ff ff       	call   80104030 <sleep>
  while(ticks - ticks0 < n){
801057e2:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105805:	e8 46 ed ff ff       	call   80104550 <release>
      return -1;
...
80105828:	e8 23 ed ff ff       	call   80104550 <release>
}
...
80105844:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105847:	68 80 3d 11 80       	push   $0x80113d80
8010584c:	e8 5f ed ff ff       	call   801045b0 <acquire>
  xticks = ticks;
80105851:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105857:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
8010585e:	e8 ed ec ff ff       	call   80104550 <release>
  return xticks;
}
...
80105886:	78 18                	js     801058a0 <sys_trace+0x30>
		return -1;
	myproc()->tracing = on;
80105888:	e8 e3 e0 ff ff       	call   80103970 <myproc>
8010588d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105890:	89 50 7c             	mov    %edx,0x7c(%eax)
	return 0;
...
801058e7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
801058ee:	08 00 00 8e 
801058f2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
801058f9:	80 
801058fa:	c1 ea 10             	shr    $0x10,%edx
801058fd:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105904:	80 
  for(i = 0; i < 256; i++)
...
80105917:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 b2 75 10 80       	push   $0x801075b2
80105926:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010592b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105931:	c1 e8 10             	shr    $0x10,%eax
80105934:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
8010593a:	e8 81 ea ff ff       	call   801043c0 <initlock>
}
...
8010595b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010595f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105992:	0f 84 58 01 00 00    	je     80105af0 <trap+0x170>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010599e:	0f 87 7c 00 00 00    	ja     80105a20 <trap+0xa0>
801059a4:	ff 24 85 fc 7b 10 80 	jmp    *-0x7fef8404(,%eax,4)
801059ab:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      release(&tickslock);
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059b0:	e8 7b c8 ff ff       	call   80102230 <ideintr>
    lapiceoi();
801059b5:	e8 36 cf ff ff       	call   801028f0 <lapiceoi>
  }
...
801059c1:	74 1a                	je     801059dd <trap+0x5d>
801059c3:	e8 a8 df ff ff       	call   80103970 <myproc>
801059c8:	8b 50 24             	mov    0x24(%eax),%edx
801059cb:	85 d2                	test   %edx,%edx
801059cd:	74 0e                	je     801059dd <trap+0x5d>
801059cf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059d3:	f7 d0                	not    %eax
801059d5:	a8 03                	test   $0x3,%al
801059d7:	0f 84 db 01 00 00    	je     80105bb8 <trap+0x238>
    exit();
...
801059e4:	74 0f                	je     801059f5 <trap+0x75>
801059e6:	e8 85 df ff ff       	call   80103970 <myproc>
801059eb:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801059ef:	0f 84 ab 00 00 00    	je     80105aa0 <trap+0x120>
...
801059fc:	74 1a                	je     80105a18 <trap+0x98>
801059fe:	e8 6d df ff ff       	call   80103970 <myproc>
80105a03:	8b 40 24             	mov    0x24(%eax),%eax
80105a06:	85 c0                	test   %eax,%eax
80105a08:	74 0e                	je     80105a18 <trap+0x98>
80105a0a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a0e:	f7 d0                	not    %eax
80105a10:	a8 03                	test   $0x3,%al
80105a12:	0f 84 05 01 00 00    	je     80105b1d <trap+0x19d>
    exit();
}
80105a18:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105a1b:	5b                   	pop    %ebx
80105a1c:	5e                   	pop    %esi
80105a1d:	5f                   	pop    %edi
80105a1e:	5d                   	pop    %ebp
...
80105a2a:	0f 84 a2 01 00 00    	je     80105bd2 <trap+0x252>
80105a30:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a34:	0f 84 98 01 00 00    	je     80105bd2 <trap+0x252>
...
80105a40:	e8 0b df ff ff       	call   80103950 <cpuid>
...
80105a75:	68 80 78 10 80       	push   $0x80107880
...
80105a95:	0f 85 28 ff ff ff    	jne    801059c3 <trap+0x43>
80105a9b:	e9 3d ff ff ff       	jmp    801059dd <trap+0x5d>
  if(myproc() && myproc()->state == RUNNING &&
80105aa0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105aa4:	0f 85 4b ff ff ff    	jne    801059f5 <trap+0x75>
    yield();
80105aaa:	e8 31 e5 ff ff       	call   80103fe0 <yield>
80105aaf:	e9 41 ff ff ff       	jmp    801059f5 <trap+0x75>
...
80105abf:	e8 8c de ff ff       	call   80103950 <cpuid>
80105ac4:	57                   	push   %edi
80105ac5:	56                   	push   %esi
80105ac6:	50                   	push   %eax
80105ac7:	68 28 78 10 80       	push   $0x80107828
80105acc:	e8 df ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ad1:	e8 1a ce ff ff       	call   801028f0 <lapiceoi>
    break;
80105ad6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ad9:	e8 92 de ff ff       	call   80103970 <myproc>
80105ade:	85 c0                	test   %eax,%eax
80105ae0:	0f 85 dd fe ff ff    	jne    801059c3 <trap+0x43>
80105ae6:	e9 f2 fe ff ff       	jmp    801059dd <trap+0x5d>
...
80105b23:	5d                   	pop    %ebp
      exit();
80105b24:	e9 57 e2 ff ff       	jmp    80103d80 <exit>
...
80105b41:	0f 85 7c fe ff ff    	jne    801059c3 <trap+0x43>
80105b47:	e9 91 fe ff ff       	jmp    801059dd <trap+0x5d>
80105b4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b50:	e8 6b cc ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105b55:	e8 96 cd ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b5a:	e8 11 de ff ff       	call   80103970 <myproc>
80105b5f:	85 c0                	test   %eax,%eax
80105b61:	0f 85 5c fe ff ff    	jne    801059c3 <trap+0x43>
80105b67:	e9 71 fe ff ff       	jmp    801059dd <trap+0x5d>
80105b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b70:	e8 db dd ff ff       	call   80103950 <cpuid>
80105b75:	85 c0                	test   %eax,%eax
80105b77:	0f 85 38 fe ff ff    	jne    801059b5 <trap+0x35>
      acquire(&tickslock);
80105b7d:	83 ec 0c             	sub    $0xc,%esp
80105b80:	68 80 3d 11 80       	push   $0x80113d80
80105b85:	e8 26 ea ff ff       	call   801045b0 <acquire>
      ticks++;
80105b8a:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105b91:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
80105b98:	e8 53 e5 ff ff       	call   801040f0 <wakeup>
      release(&tickslock);
80105b9d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105ba4:	e8 a7 e9 ff ff       	call   80104550 <release>
80105ba9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105bac:	e9 04 fe ff ff       	jmp    801059b5 <trap+0x35>
80105bb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105bb8:	e8 c3 e1 ff ff       	call   80103d80 <exit>
80105bbd:	e9 1b fe ff ff       	jmp    801059dd <trap+0x5d>
80105bc2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bc8:	e8 b3 e1 ff ff       	call   80103d80 <exit>
80105bcd:	e9 2e ff ff ff       	jmp    80105b00 <trap+0x180>
80105bd2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105bd5:	e8 76 dd ff ff       	call   80103950 <cpuid>
80105bda:	83 ec 0c             	sub    $0xc,%esp
80105bdd:	56                   	push   %esi
80105bde:	57                   	push   %edi
80105bdf:	50                   	push   %eax
80105be0:	ff 73 30             	push   0x30(%ebx)
80105be3:	68 4c 78 10 80       	push   $0x8010784c
80105be8:	e8 c3 aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bed:	83 c4 14             	add    $0x14,%esp
80105bf0:	68 36 76 10 80       	push   $0x80107636
...
{
  if(!uart)
80105c00:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105c87:	0f 84 7c 00 00 00    	je     80105d09 <uartinit+0xd9>
  uart = 1;
80105c8d:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105c94:	00 00 00 
...
80105ca0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ca3:	bf 3b 76 10 80       	mov    $0x8010763b,%edi
80105ca8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105cad:	6a 00                	push   $0x0
80105caf:	6a 04                	push   $0x4
80105cb1:	e8 aa c7 ff ff       	call   80102460 <ioapicenable>
80105cb6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105cb9:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
80105cbd:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105cc0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105d0f:	5d                   	pop    %ebp
80105d10:	c3                   	ret
80105d11:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105d18:	00 
80105d19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105d20 <uartputc>:
  if(!uart)
80105d20:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105d8b:	e8 10 ab ff ff       	call   801008a0 <consoleintr>
}
...
80105d97:	6a 00                	push   $0x0
  jmp alltraps
80105d99:	e9 09 fb ff ff       	jmp    801058a7 <alltraps>
...
80105da0:	6a 01                	push   $0x1
  jmp alltraps
80105da2:	e9 00 fb ff ff       	jmp    801058a7 <alltraps>
...
80105da9:	6a 02                	push   $0x2
  jmp alltraps
80105dab:	e9 f7 fa ff ff       	jmp    801058a7 <alltraps>
...
80105db2:	6a 03                	push   $0x3
  jmp alltraps
80105db4:	e9 ee fa ff ff       	jmp    801058a7 <alltraps>
...
80105dbb:	6a 04                	push   $0x4
  jmp alltraps
80105dbd:	e9 e5 fa ff ff       	jmp    801058a7 <alltraps>
...
80105dc4:	6a 05                	push   $0x5
  jmp alltraps
80105dc6:	e9 dc fa ff ff       	jmp    801058a7 <alltraps>
...
80105ddd:	6a 08                	push   $0x8
  jmp alltraps
80105ddf:	e9 c3 fa ff ff       	jmp    801058a7 <alltraps>
...
80105ded:	6a 0a                	push   $0xa
  jmp alltraps
80105def:	e9 b3 fa ff ff       	jmp    801058a7 <alltraps>
...
80105df4:	6a 0b                	push   $0xb
  jmp alltraps
80105df6:	e9 ac fa ff ff       	jmp    801058a7 <alltraps>
...
80105dfb:	6a 0c                	push   $0xc
  jmp alltraps
80105dfd:	e9 a5 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e02:	6a 0d                	push   $0xd
  jmp alltraps
80105e04:	e9 9e fa ff ff       	jmp    801058a7 <alltraps>
...
80105e09:	6a 0e                	push   $0xe
  jmp alltraps
80105e0b:	e9 97 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e12:	6a 0f                	push   $0xf
  jmp alltraps
80105e14:	e9 8e fa ff ff       	jmp    801058a7 <alltraps>
...
80105e1b:	6a 10                	push   $0x10
  jmp alltraps
80105e1d:	e9 85 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e22:	6a 11                	push   $0x11
  jmp alltraps
80105e24:	e9 7e fa ff ff       	jmp    801058a7 <alltraps>
...
80105e2b:	6a 12                	push   $0x12
  jmp alltraps
80105e2d:	e9 75 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e34:	6a 13                	push   $0x13
  jmp alltraps
80105e36:	e9 6c fa ff ff       	jmp    801058a7 <alltraps>
...
80105e3d:	6a 14                	push   $0x14
  jmp alltraps
80105e3f:	e9 63 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e46:	6a 15                	push   $0x15
  jmp alltraps
80105e48:	e9 5a fa ff ff       	jmp    801058a7 <alltraps>
...
80105e4f:	6a 16                	push   $0x16
  jmp alltraps
80105e51:	e9 51 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e58:	6a 17                	push   $0x17
  jmp alltraps
80105e5a:	e9 48 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e61:	6a 18                	push   $0x18
  jmp alltraps
80105e63:	e9 3f fa ff ff       	jmp    801058a7 <alltraps>
...
80105e6a:	6a 19                	push   $0x19
  jmp alltraps
80105e6c:	e9 36 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e73:	6a 1a                	push   $0x1a
  jmp alltraps
80105e75:	e9 2d fa ff ff       	jmp    801058a7 <alltraps>
...
80105e7c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e7e:	e9 24 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e85:	6a 1c                	push   $0x1c
  jmp alltraps
80105e87:	e9 1b fa ff ff       	jmp    801058a7 <alltraps>
...
80105e8e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e90:	e9 12 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e97:	6a 1e                	push   $0x1e
  jmp alltraps
80105e99:	e9 09 fa ff ff       	jmp    801058a7 <alltraps>
...
80105ea0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ea2:	e9 00 fa ff ff       	jmp    801058a7 <alltraps>
...
80105ea9:	6a 20                	push   $0x20
  jmp alltraps
80105eab:	e9 f7 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105eb2:	6a 21                	push   $0x21
  jmp alltraps
80105eb4:	e9 ee f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ebb:	6a 22                	push   $0x22
  jmp alltraps
80105ebd:	e9 e5 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ec4:	6a 23                	push   $0x23
  jmp alltraps
80105ec6:	e9 dc f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ecd:	6a 24                	push   $0x24
  jmp alltraps
80105ecf:	e9 d3 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ed6:	6a 25                	push   $0x25
  jmp alltraps
80105ed8:	e9 ca f9 ff ff       	jmp    801058a7 <alltraps>
...
80105edf:	6a 26                	push   $0x26
  jmp alltraps
80105ee1:	e9 c1 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ee8:	6a 27                	push   $0x27
  jmp alltraps
80105eea:	e9 b8 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ef1:	6a 28                	push   $0x28
  jmp alltraps
80105ef3:	e9 af f9 ff ff       	jmp    801058a7 <alltraps>
...
80105efa:	6a 29                	push   $0x29
  jmp alltraps
80105efc:	e9 a6 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f03:	6a 2a                	push   $0x2a
  jmp alltraps
80105f05:	e9 9d f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f0c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f0e:	e9 94 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f15:	6a 2c                	push   $0x2c
  jmp alltraps
80105f17:	e9 8b f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f1e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f20:	e9 82 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f27:	6a 2e                	push   $0x2e
  jmp alltraps
80105f29:	e9 79 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f30:	6a 2f                	push   $0x2f
  jmp alltraps
80105f32:	e9 70 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f39:	6a 30                	push   $0x30
  jmp alltraps
80105f3b:	e9 67 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f42:	6a 31                	push   $0x31
  jmp alltraps
80105f44:	e9 5e f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f4b:	6a 32                	push   $0x32
  jmp alltraps
80105f4d:	e9 55 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f54:	6a 33                	push   $0x33
  jmp alltraps
80105f56:	e9 4c f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f5d:	6a 34                	push   $0x34
  jmp alltraps
80105f5f:	e9 43 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f66:	6a 35                	push   $0x35
  jmp alltraps
80105f68:	e9 3a f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f6f:	6a 36                	push   $0x36
  jmp alltraps
80105f71:	e9 31 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f78:	6a 37                	push   $0x37
  jmp alltraps
80105f7a:	e9 28 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f81:	6a 38                	push   $0x38
  jmp alltraps
80105f83:	e9 1f f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f8a:	6a 39                	push   $0x39
  jmp alltraps
80105f8c:	e9 16 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f93:	6a 3a                	push   $0x3a
  jmp alltraps
80105f95:	e9 0d f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f9c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f9e:	e9 04 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105fa5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fa7:	e9 fb f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fae:	6a 3d                	push   $0x3d
  jmp alltraps
80105fb0:	e9 f2 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fb7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fb9:	e9 e9 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fc0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fc2:	e9 e0 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fc9:	6a 40                	push   $0x40
  jmp alltraps
80105fcb:	e9 d7 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fd2:	6a 41                	push   $0x41
  jmp alltraps
80105fd4:	e9 ce f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fdb:	6a 42                	push   $0x42
  jmp alltraps
80105fdd:	e9 c5 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fe4:	6a 43                	push   $0x43
  jmp alltraps
80105fe6:	e9 bc f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fed:	6a 44                	push   $0x44
  jmp alltraps
80105fef:	e9 b3 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105ff6:	6a 45                	push   $0x45
  jmp alltraps
80105ff8:	e9 aa f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fff:	6a 46                	push   $0x46
  jmp alltraps
80106001:	e9 a1 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106008:	6a 47                	push   $0x47
  jmp alltraps
8010600a:	e9 98 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106011:	6a 48                	push   $0x48
  jmp alltraps
80106013:	e9 8f f8 ff ff       	jmp    801058a7 <alltraps>
...
8010601a:	6a 49                	push   $0x49
  jmp alltraps
8010601c:	e9 86 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106023:	6a 4a                	push   $0x4a
  jmp alltraps
80106025:	e9 7d f8 ff ff       	jmp    801058a7 <alltraps>
...
8010602c:	6a 4b                	push   $0x4b
  jmp alltraps
8010602e:	e9 74 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106035:	6a 4c                	push   $0x4c
  jmp alltraps
80106037:	e9 6b f8 ff ff       	jmp    801058a7 <alltraps>
...
8010603e:	6a 4d                	push   $0x4d
  jmp alltraps
80106040:	e9 62 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106047:	6a 4e                	push   $0x4e
  jmp alltraps
80106049:	e9 59 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106050:	6a 4f                	push   $0x4f
  jmp alltraps
80106052:	e9 50 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106059:	6a 50                	push   $0x50
  jmp alltraps
8010605b:	e9 47 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106062:	6a 51                	push   $0x51
  jmp alltraps
80106064:	e9 3e f8 ff ff       	jmp    801058a7 <alltraps>
...
8010606b:	6a 52                	push   $0x52
  jmp alltraps
8010606d:	e9 35 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106074:	6a 53                	push   $0x53
  jmp alltraps
80106076:	e9 2c f8 ff ff       	jmp    801058a7 <alltraps>
...
8010607d:	6a 54                	push   $0x54
  jmp alltraps
8010607f:	e9 23 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106086:	6a 55                	push   $0x55
  jmp alltraps
80106088:	e9 1a f8 ff ff       	jmp    801058a7 <alltraps>
...
8010608f:	6a 56                	push   $0x56
  jmp alltraps
80106091:	e9 11 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106098:	6a 57                	push   $0x57
  jmp alltraps
8010609a:	e9 08 f8 ff ff       	jmp    801058a7 <alltraps>
...
801060a1:	6a 58                	push   $0x58
  jmp alltraps
801060a3:	e9 ff f7 ff ff       	jmp    801058a7 <alltraps>
...
801060aa:	6a 59                	push   $0x59
  jmp alltraps
801060ac:	e9 f6 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060b3:	6a 5a                	push   $0x5a
  jmp alltraps
801060b5:	e9 ed f7 ff ff       	jmp    801058a7 <alltraps>
...
801060bc:	6a 5b                	push   $0x5b
  jmp alltraps
801060be:	e9 e4 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060c5:	6a 5c                	push   $0x5c
  jmp alltraps
801060c7:	e9 db f7 ff ff       	jmp    801058a7 <alltraps>
...
801060ce:	6a 5d                	push   $0x5d
  jmp alltraps
801060d0:	e9 d2 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060d7:	6a 5e                	push   $0x5e
  jmp alltraps
801060d9:	e9 c9 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060e0:	6a 5f                	push   $0x5f
  jmp alltraps
801060e2:	e9 c0 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060e9:	6a 60                	push   $0x60
  jmp alltraps
801060eb:	e9 b7 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060f2:	6a 61                	push   $0x61
  jmp alltraps
801060f4:	e9 ae f7 ff ff       	jmp    801058a7 <alltraps>
...
801060fb:	6a 62                	push   $0x62
  jmp alltraps
801060fd:	e9 a5 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106104:	6a 63                	push   $0x63
  jmp alltraps
80106106:	e9 9c f7 ff ff       	jmp    801058a7 <alltraps>
...
8010610d:	6a 64                	push   $0x64
  jmp alltraps
8010610f:	e9 93 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106116:	6a 65                	push   $0x65
  jmp alltraps
80106118:	e9 8a f7 ff ff       	jmp    801058a7 <alltraps>
...
8010611f:	6a 66                	push   $0x66
  jmp alltraps
80106121:	e9 81 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106128:	6a 67                	push   $0x67
  jmp alltraps
8010612a:	e9 78 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106131:	6a 68                	push   $0x68
  jmp alltraps
80106133:	e9 6f f7 ff ff       	jmp    801058a7 <alltraps>
...
8010613a:	6a 69                	push   $0x69
  jmp alltraps
8010613c:	e9 66 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106143:	6a 6a                	push   $0x6a
  jmp alltraps
80106145:	e9 5d f7 ff ff       	jmp    801058a7 <alltraps>
...
8010614c:	6a 6b                	push   $0x6b
  jmp alltraps
8010614e:	e9 54 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106155:	6a 6c                	push   $0x6c
  jmp alltraps
80106157:	e9 4b f7 ff ff       	jmp    801058a7 <alltraps>
...
8010615e:	6a 6d                	push   $0x6d
  jmp alltraps
80106160:	e9 42 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106167:	6a 6e                	push   $0x6e
  jmp alltraps
80106169:	e9 39 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106170:	6a 6f                	push   $0x6f
  jmp alltraps
80106172:	e9 30 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106179:	6a 70                	push   $0x70
  jmp alltraps
8010617b:	e9 27 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106182:	6a 71                	push   $0x71
  jmp alltraps
80106184:	e9 1e f7 ff ff       	jmp    801058a7 <alltraps>
...
8010618b:	6a 72                	push   $0x72
  jmp alltraps
8010618d:	e9 15 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106194:	6a 73                	push   $0x73
  jmp alltraps
80106196:	e9 0c f7 ff ff       	jmp    801058a7 <alltraps>
...
8010619d:	6a 74                	push   $0x74
  jmp alltraps
8010619f:	e9 03 f7 ff ff       	jmp    801058a7 <alltraps>
...
801061a6:	6a 75                	push   $0x75
  jmp alltraps
801061a8:	e9 fa f6 ff ff       	jmp    801058a7 <alltraps>
...
801061af:	6a 76                	push   $0x76
  jmp alltraps
801061b1:	e9 f1 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061b8:	6a 77                	push   $0x77
  jmp alltraps
801061ba:	e9 e8 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061c1:	6a 78                	push   $0x78
  jmp alltraps
801061c3:	e9 df f6 ff ff       	jmp    801058a7 <alltraps>
...
801061ca:	6a 79                	push   $0x79
  jmp alltraps
801061cc:	e9 d6 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061d3:	6a 7a                	push   $0x7a
  jmp alltraps
801061d5:	e9 cd f6 ff ff       	jmp    801058a7 <alltraps>
...
801061e5:	6a 7c                	push   $0x7c
  jmp alltraps
801061e7:	e9 bb f6 ff ff       	jmp    801058a7 <alltraps>
...
801061ee:	6a 7d                	push   $0x7d
  jmp alltraps
801061f0:	e9 b2 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061f7:	6a 7e                	push   $0x7e
  jmp alltraps
801061f9:	e9 a9 f6 ff ff       	jmp    801058a7 <alltraps>
...
801067cd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067d2:	e9 d0 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067d9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067de:	e9 c4 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067e5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ea:	e9 b8 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067f1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067f6:	e9 ac f0 ff ff       	jmp    801058a7 <alltraps>
...
801067fd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106802:	e9 a0 f0 ff ff       	jmp    801058a7 <alltraps>
...
801068ab:	e8 f0 bb ff ff       	call   801024a0 <kfree>
      *pte = 0;
...
801068c1:	68 ac 73 10 80       	push   $0x801073ac
801068c6:	e8 b5 9a ff ff       	call   80100380 <panic>
801068cb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
80106950:	e8 0b bd ff ff       	call   80102660 <kalloc>
...
80106967:	e8 44 dd ff ff       	call   801046b0 <memset>
...
801069ad:	68 43 76 10 80       	push   $0x80107643
801069b2:	e8 c9 99 ff ff       	call   80100380 <panic>
801069b7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801069be:	00 
801069bf:	90                   	nop
...
80106b8b:	77 49                	ja     80106bd6 <inituvm+0x66>
  mem = kalloc();
80106b8d:	e8 ce ba ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bc1:	89 75 10             	mov    %esi,0x10(%ebp)
...
80106bd0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bd1:	e9 6a db ff ff       	jmp    80104740 <memmove>
    panic("inituvm: more than a page");
80106bd6:	83 ec 0c             	sub    $0xc,%esp
80106bd9:	68 88 76 10 80       	push   $0x80107688
80106bde:	e8 9d 97 ff ff       	call   80100380 <panic>
80106be3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106bea:	00 
...
80106c28:	68 a2 76 10 80       	push   $0x801076a2
...
80106c76:	e8 35 ae ff ff       	call   80101ab0 <readi>
...
80106c94:	5d                   	pop    %ebp
80106c95:	c3                   	ret
80106c96:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106c9d:	00 
...
80106cb0:	68 c4 78 10 80       	push   $0x801078c4
...
80106d0b:	e8 a0 d9 ff ff       	call   801046b0 <memset>
...
80106d39:	0f 83 89 00 00 00    	jae    80106dc8 <allocuvm+0x108>
    mem = kalloc();
80106d3f:	e8 1c b9 ff ff       	call   80102660 <kalloc>
...
80106d4d:	68 c0 76 10 80       	push   $0x801076c0
...
80106d93:	68 d8 76 10 80       	push   $0x801076d8
...
80106db6:	e8 e5 b6 ff ff       	call   801024a0 <kfree>
      return 0;
...
80106dd3:	5d                   	pop    %ebp
80106dd4:	c3                   	ret
80106dd5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106ddc:	00 
...
80106df6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106dfd:	00 
...
80106e38:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106e3f:	00 
...
80106e5e:	e8 3d b6 ff ff       	call   801024a0 <kfree>
...
80106e73:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e74:	e9 27 b6 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80106e79:	83 ec 0c             	sub    $0xc,%esp
80106e7c:	68 f4 76 10 80       	push   $0x801076f4
...
80106e95:	e8 c6 b7 ff ff       	call   80102660 <kalloc>
...
80106f1b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f4c:	68 05 77 10 80       	push   $0x80107705
...
80106fc2:	68 0f 77 10 80       	push   $0x8010770f
...
80106fff:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107005:	e8 56 b6 ff ff       	call   80102660 <kalloc>
...
80107020:	e8 1b d7 ff ff       	call   80104740 <memmove>
...
8010706c:	e8 2f b4 ff ff       	call   801024a0 <kfree>
      goto bad;
...
80107097:	68 29 77 10 80       	push   $0x80107729
8010709c:	e8 df 92 ff ff       	call   80100380 <panic>
801070a1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801070a8:	00 
...
801070c4:	0f 84 f8 00 00 00    	je     801071c2 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801070d4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801070d9:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070e0:	89 d0                	mov    %edx,%eax
801070e2:	f7 d2                	not    %edx
801070e4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801070e9:	05 00 00 00 80       	add    $0x80000000,%eax
801070ee:	83 e2 05             	and    $0x5,%edx
801070f1:	ba 00 00 00 00       	mov    $0x0,%edx
801070f6:	0f 45 c2             	cmovne %edx,%eax
}
801070f9:	c3                   	ret
...
80107116:	e9 9d 00 00 00       	jmp    801071b8 <copyout+0xb8>
...
80107132:	74 74                	je     801071a8 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
...
80107150:	e8 eb d5 ff ff       	call   80104740 <memmove>
    len -= n;
    buf += n;
...
80107165:	74 51                	je     801071b8 <copyout+0xb8>
  if(*pde & PTE_P){
...
8010717d:	0f 84 46 00 00 00    	je     801071c9 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010719d:	f7 d1                	not    %ecx
8010719f:	83 e1 05             	and    $0x5,%ecx
801071a2:	0f 84 78 ff ff ff    	je     80107120 <copyout+0x20>
  }
  return 0;
}
...
801071c2 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801071c2:	a1 00 00 00 00       	mov    0x0,%eax
801071c7:	0f 0b                	ud2

801071c9 <copyout.cold>:
801071c9:	a1 00 00 00 00       	mov    0x0,%eax
801071ce:	0f 0b                	ud2
